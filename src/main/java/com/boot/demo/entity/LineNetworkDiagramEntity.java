...
public class LineNetworkDiagramEntity {
    ...
    private String nextStation="Sta1";
...
//    }
    ...
    public JSONObject getLineTitleJson(){
        ...
        json.put("value",new int[]{positionX,positionY});
    ...
    public JSONObject getStationJson(){
        ...
        json.put("symbolSize",new int[]{size,size});
        json.put("value",new int[]{positionX,positionY});
