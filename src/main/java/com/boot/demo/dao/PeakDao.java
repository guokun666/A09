...
public interface PeakDao {
   ...
   PeakEntity getCityPercentage(@Param("year") Integer year);
   List<PeakEntity> getLinePeak(@Param("year") Integer year,@Param("singleline")String singleline);//实体里的字段名字
   PeakEntity getLinePercentage(@Param("year") Integer year,@Param("singleline")String singleline);
   ...
   PeakEntity getLineMonthPercentage(@Param("year") Integer year,@Param("singleline")String singleline,@Param("month")Integer month);
}
