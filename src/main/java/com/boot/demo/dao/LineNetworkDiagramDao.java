...
public interface LineNetworkDiagramDao {
     ...
     List<LineNetworkDiagramEntity> getSingleLineStationInformation(@Param("line")String line);

     List<LineNetworkDiagramEntity> getSingleLineTrainInformation(@Param("line")String line);
